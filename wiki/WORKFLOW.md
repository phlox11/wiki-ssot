...
<!-- kit:exclude:start -->
- protection status for this repository: [proposal/protected-main](./proposals/protected-main.md) until it is active; enforcement detail in [operations/enforcement](./operations/enforcement.md).
<!-- kit:exclude:end -->
