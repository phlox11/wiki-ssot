...
Outstanding work: 20. Completed work hidden: 26; run `bun run wiki:work -- --all` to inspect it.
...
| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| KM-00-OWNER | normal | human | [proposal/kit-code-splitting](./proposals/kit-code-splitting.md) | KM-00 | Ratify the portable-kit module budget and split contract | `bun run wiki:context -- --work KM-00-OWNER` |
