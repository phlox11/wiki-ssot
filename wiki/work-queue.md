...
| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| TE-00 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | — | Freeze the schooled diagnosis and publisher-only comparison contract | `bun run wiki:context -- --work TE-00` |

## Waiting

| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| TE-00-OWNER | high | human | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00 | Ratify the publisher-only efficiency and performance contract — Waiting on: TE-00 | `bun run wiki:context -- --work TE-00-OWNER` |
...
| TE-02 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00-OWNER, TE-05 | Bound partial-match discovery before full context expansion — Waiting on: TE-00-OWNER, TE-05 | `bun run wiki:context -- --work TE-02` |
...
| TE-03 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00-OWNER, TE-04 | Partition the recursive engine source authority boundary — Deferred: Activate only when the controlled publisher evidence shows that a broad source declaration adds unrelated required-source breadth and a shadow partition reduces required-source count or bytes by at least 20% without weakening coverage, impact, or review completeness. | `bun run wiki:context -- --work TE-03` |
