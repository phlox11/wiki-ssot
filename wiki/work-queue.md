...
| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| TE-00-OWNER | high | human | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00 | Ratify the publisher-only efficiency and performance contract | `bun run wiki:context -- --work TE-00-OWNER` |
