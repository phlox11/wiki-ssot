...
| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| TE-00 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | — | Capture the cross-repository token and performance baseline | `bun run wiki:context -- --work TE-00` |

## Waiting

| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| TE-00-OWNER | high | human | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00 | Ratify the cross-repository efficiency and performance contract — Waiting on: TE-00 | `bun run wiki:context -- --work TE-00-OWNER` |
| TE-01 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00-OWNER, TE-05 | Add compact context projections with explicit full expansion — Waiting on: TE-00-OWNER, TE-05 | `bun run wiki:context -- --work TE-01` |
| TE-02 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00-OWNER, TE-01, TE-05 | Bound partial-match discovery before full context expansion — Waiting on: TE-00-OWNER, TE-01, TE-05 | `bun run wiki:context -- --work TE-02` |
| TE-04 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00-OWNER, TE-01, TE-02 | Focus exact-HEAD review inputs and reduce reviewer round trips — Waiting on: TE-00-OWNER, TE-01, TE-02 | `bun run wiki:context -- --work TE-04` |
| TE-05 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00-OWNER | Bound orchestration round trips and reusable context boundaries — Waiting on: TE-00-OWNER | `bun run wiki:context -- --work TE-05` |
| TE-06 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-01, TE-02, TE-04, TE-05 | Validate cross-repository token and performance gains — Waiting on: TE-01, TE-02, TE-04, TE-05 | `bun run wiki:context -- --work TE-06` |
| TE-06-OWNER | high | human | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-06 | Record the cross-repository efficiency owner exit decision — Waiting on: TE-06 | `bun run wiki:context -- --work TE-06-OWNER` |
...
| TE-03 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-00-OWNER | Partition the recursive engine source authority boundary — Deferred: Activate only when measured adopter evidence shows that a broad source declaration adds unrelated required-source breadth and a shadow partition reduces required-source count or bytes by at least 20% without weakening coverage, impact, or review completeness. | `bun run wiki:context -- --work TE-03` |
