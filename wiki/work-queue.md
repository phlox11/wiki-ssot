...
**Recommended next:** `KM-01` — run `bun run wiki:context -- --work KM-01`.

Outstanding work: 19. Completed work hidden: 27; run `bun run wiki:work -- --all` to inspect it.
...
| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| KM-01 | normal | agent | [proposal/kit-code-splitting](./proposals/kit-code-splitting.md) | KM-00-OWNER | Extract shared model, repository-view, and page-validation primitives | `bun run wiki:context -- --work KM-01` |
