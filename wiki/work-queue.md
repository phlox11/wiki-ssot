...
Outstanding work: 16. Completed work hidden: 30; run `bun run wiki:work -- --all` to inspect it.
...
| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| KM-04 | normal | agent | [proposal/kit-code-splitting](./proposals/kit-code-splitting.md) | KM-03 | Extract verification, impact, and exact-HEAD review modules | `bun run wiki:context -- --work KM-04` |
