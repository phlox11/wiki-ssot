...
Outstanding work: 24. Completed work hidden: 22; run `bun run wiki:work -- --all` to inspect it.
...
| ID | Priority | Executor | Owner page | Dependencies | Summary | Context |
|---|---|---|---|---|---|---|
| TE-06 | high | agent | [proposal/token-efficiency](./proposals/token-efficiency.md) | TE-01, TE-02, TE-04, TE-05 | Validate publisher-repository token and performance gains — Waiting on: TE-04 | `bun run wiki:context -- --work TE-06` |
