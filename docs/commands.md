...
| `wiki:doctor` | Validate required downstream seams: explicit config, meaningful provider-neutral AGENTS authority/work/context routes, canonical commands, PR template, and GitHub job/events. | pre-commit + CI |
