...
export const KIT_ENTRIES: KitEntry[] = [
  ...
  { target: "scripts/wiki/cli-runtime.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/cli-runtime.ts" } },
  { target: "scripts/wiki/cli-render.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/cli-render.ts" } },
  { target: "scripts/wiki/cli-discovery-handlers.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/cli-discovery-handlers.ts" } },
  ...
  { target: "scripts/wiki/test-fixtures/fresh-context.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/test-fixtures/fresh-context.ts" } },
  { target: "scripts/wiki/test-fixtures/wiki.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/test-fixtures/wiki.ts" } },
  { target: "scripts/wiki/test-fixtures/work.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/test-fixtures/work.ts" } },
  { target: "scripts/wiki/fresh-context-manifest.test.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/fresh-context-manifest.test.ts" } },
  { target: "scripts/wiki/fresh-context-preflight.test.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/fresh-context-preflight.test.ts" } },
  { target: "scripts/wiki/fresh-context-report.test.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/fresh-context-report.test.ts" } },
  ...
  { target: "scripts/wiki/wiki-impact-conflicts.test.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/wiki-impact-conflicts.test.ts" } },
  { target: "scripts/wiki/wiki-repository-hooks.test.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/wiki-repository-hooks.test.ts" } },
  { target: "scripts/wiki/work-selected-context.test.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/work-selected-context.test.ts" } },
  { target: "scripts/wiki/work-topic-context.test.ts", placement: "files", source: { kind: "copy", from: "scripts/wiki/work-topic-context.test.ts" } },
